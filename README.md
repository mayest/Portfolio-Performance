...
# Downloads
Go to the [latest release page](https://github.com/mayest/Portfolio-Performance/releases/latest),
...
After downloading, unzip the file and load the .xll file in Excel via:

File → Options → Add-ins → Manage: Excel Add-ins → Go → Browse → Select the .xll file.

Most modern installations of Excel (including Microsoft 365 and Windows 11) are 64-bit.
